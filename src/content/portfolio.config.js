...
// Only this block changes per branch. Everything below is shared across versions.

export const versionConfig = {
    meta: {
        title: "Iván Serralta — Full-Stack Developer & Builder",
        description: "Builder y desarrollador full-stack con 4 años de experiencia. Construyo productos digitales completos desde la arquitectura hasta el deploy.",
    },
    hero: {
        titleLine1: "BUILDER.",
        titleLine2: "DEVELOPER.",
        taglineItems: ["Builder.", "Developer.", "Estratega tech."],
        subheadline: "Construyo productos digitales completos — desde la arquitectura hasta el deploy.",
        ctaPrimary:   { label: "Ver mi trabajo",  href: "#projects" },
        ctaSecondary: { label: "Contacto",         href: "#contact"  },
    },
    about: {
        bio: "Full-Stack Engineer y Acting CTO con 4 años de experiencia construyendo productos digitales completos — desde la arquitectura hasta el deploy. Especializado en SaaS, fintech, automatización e IA. Perfil híbrido: engineer, builder, líder técnico y operador de negocios. Con mentalidad emprendedora, orientación a resultados y capacidad de encontrar oportunidades donde otros ven fricción operacional.",
    },
    profileCard: {
        badge: "Available for work",
        bio: "Full-Stack Developer & Builder. Construyo productos digitales completos, de la arquitectura al deploy.",
    },
    // null = show all projects in default order; array = show only these projects
...
export const dataportfolio = [
    ...
    },
    {
        ...
        description: "Intelligent chatbot for a nautical school — answers questions, schedules lessons, manages enrollments. (WIP)",
...
export const meta = versionConfig.meta;
...
export const introdata = {
    ...
    description: versionConfig.hero.subheadline,
    your_img_url: ""
};

export const dataabout = {
    title: "About Me",
    aboutme: versionConfig.about.bio,
};
...
export const logotext = "SERRADEV";
